...
<script>
import { hospitalization, refundhospitalized } from "@/utils/DataInteraction";
...
export default {
    ...
    methods: {
        getHospitalData(i) {
            hospitalization({ id: hospitalId, page: i, limit: 10 }).then((res) => {
                this.data1 = res.data;
        ...
        ok() {
            refundhospitalized({ out_trade_no: this.data1[this.indexInfo].out_trade_no, total_fee: this.data1[this.indexInfo].total_fee, refund_fee: this.tkje }).then((res) => {
